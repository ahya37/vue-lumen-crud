                            ...
                            <tbody>
                                <tr v-for="post in posts" :key="post.id">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button v-on:click="delteConfirm">DELETE</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get('http://localhost/MyApps/public/posts').then(response => {
                this.posts = response.data.data;
            });
        },
        methods: {
            PostDelete(id) {
                axios.delete(`http://localhost/MyApps/public/posts/${id}`)
                    .then(response => {
